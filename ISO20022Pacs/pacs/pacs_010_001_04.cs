...
namespace Iso20022.Model.pacs_010_001_04
{
    ...
    {
        public virtual FinancialInstitutionDirectDebitV04 FIDrctDbt { get; set; }
    ...
    public class FinancialInstitutionDirectDebitV04
    {
        ...
        public virtual CreditTransferTransaction47[] CdtInstr { get; set; }
