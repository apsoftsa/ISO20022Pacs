...
namespace Iso20022.Model.pacs_028_001_02
{
    ...
    {
        public virtual FIToFIPaymentStatusRequestV02 FIToFIPmtStsReq { get; set; }
    ...
    public class FIToFIPaymentStatusRequestV02
    {
        ...
        public virtual PaymentTransaction94[] TxInf { get; set; }
