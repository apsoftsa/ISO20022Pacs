...
namespace Iso20022.Model.pacs_009_001_10
{
    ...
    {
        public virtual FinancialInstitutionCreditTransferV10 FICdtTrf { get; set; }
    ...
    public class FinancialInstitutionCreditTransferV10
    {
        ...
        public virtual CreditTransferTransaction56[] CdtTrfTxInf { get; set; }
