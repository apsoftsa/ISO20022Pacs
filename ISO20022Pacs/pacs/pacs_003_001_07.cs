...
namespace Iso20022.Model.pacs_003_001_07
{
    ...
    {
        public virtual FIToFICustomerDirectDebitV07 FIToFICstmrDrctDbt { get; set; }
    ...
    public class FIToFICustomerDirectDebitV07
    {
        ...
        public virtual DirectDebitTransactionInformation21[] DrctDbtTxInf { get; set; }
