...
namespace Iso20022.Model.pacs_008_001_08
{
    ...
    {
        public virtual FIToFICustomerCreditTransferV08 FIToFICstmrCdtTrf { get; set; }
    ...
    public class FIToFICustomerCreditTransferV08
    {
        ...
        public virtual CreditTransferTransaction39[] CdtTrfTxInf { get; set; }
